...
func TestPretty(t *testing.T) {
	...
	actual, err := print.Printer{PrinterInterface: pretty.Pretty{}}.Print(doc, settings)
	if err != nil {
		t.Fatal(err)
	}
...
func TestPrettyWithModules(t *testing.T) {
	doc := doc.TestDoc(t, "..")
	var settings settings.Settings
...
func TestPrettyWithResources(t *testing.T) {
	doc := doc.TestDoc(t, "..")
	var settings settings.Settings
