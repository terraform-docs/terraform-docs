...
```bash
curl -Lo ./terraform-docs.tar.gz https://github.com/rquadling/terraform-docs/releases/download/v0.24.0-raq.3/terraform-docs-v0.21.0-$(uname)-amd64.tar.gz
...
```bash
# go1.17+
go install github.com/rquadling/terraform-docs@v0.24.0-raq.3
```

```bash
# go1.16
GO111MODULE="on" go get github.com/rquadling/terraform-docs@v0.24.0-raq.3
```
...
```bash
docker run --rm --volume "$(pwd):/terraform-docs" -u $(id -u) quay.io/rquadling/terraform-docs:0.24.0-raq.3 markdown /terraform-docs
```
...
```bash
docker run --rm --volume "$(pwd):/terraform-docs" -u $(id -u) quay.io/rquadling/terraform-docs:0.24.0-raq.3 markdown /terraform-docs > doc.md
```
