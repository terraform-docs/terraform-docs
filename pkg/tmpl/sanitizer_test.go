...
func TestEscapeIllegalCharacters(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "escape pipe escape illegal characters",
			input:       "lorem | ipsum_dolor `consectetur | adipi_scing * elit` | sit * amet",
			escapePipe:  true,
			escapeChars: true,
			expected:    "lorem \\| ipsum\\_dolor `consectetur | adipi_scing * elit` \\| sit \\* amet",
		},
		{
			name:        "escape pipe escape illegal characters",
			input:       "lorem ||| ipsum___dolor `consectetur ||| adipi___scing *** elit` | sit *** amet",
			escapePipe:  true,
			escapeChars: true,
			expected:    "lorem \\|\\|\\| ipsum\\_\\_\\_dolor `consectetur | adipi___scing *** elit` \\|\\|\\| sit \\*\\*\\* amet",
		},
		{
			name:        "do not escape pipe escape illegal characters",
			input:       "lorem | ipsum_dolor `consectetur | adipi_scing * elit` | sit * amet",
			escapePipe:  false,
			escapeChars: true,
			expected:    "lorem | ipsum\\_dolor `consectetur | adipi_scing * elit` | sit \\* amet",
		...
		{
			name:        "escape pipe do not escape illegal characters",
			input:       "lorem | ipsum_dolor `consectetur | adipi_scing * elit` | sit * amet",
			escapePipe:  true,
			escapeChars: false,
			expected:    "lorem \\| ipsum_dolor `consectetur | adipi_scing * elit` \\| sit * amet",
		},
		{
			name:        "escape pipe do not escape illegal characters",
			input:       "lorem ||| ipsum___dolor `consectetur ||| adipi___scing *** elit` ||| sit *** amet",
			escapePipe:  true,
			escapeChars: false,
			expected:    "lorem \\|\\|\\| ipsum___dolor `consectetur ||| adipi___scing *** elit` \\|\\|\\| sit *** amet",
		},
		{
			name:        "do not escape pipe do not escape illegal characters",
			input:       "lorem | ipsum_dolor `consectetur | adipi_scing * elit` | sit * amet",
			escapePipe:  false,
			escapeChars: false,
			expected:    "lorem | ipsum_dolor `consectetur | adipi_scing * elit` | sit * amet",
